    ...
    >
      ...
      >
        <header className="p-4 border-b border-gray-700 flex justify-between items-center shrink-0">
          <h2 className="text-xl font-bold">What's New in v2.0.1</h2>
        ...
        <main className="p-6 flex-1 overflow-y-auto space-y-4">
            <h3 className="text-lg font-bold text-gray-100">New View: LWServer Fleet Management</h3>
            
            <Feature title="Architectural Visibility">
                A new "LWServer Fleet" view has been added to the main navigation. This provides a real-time dashboard of all deployed LWServers, visualizing the critical middle tier of the platform's architecture that aggregates data from endpoint agents.
            </Feature>
